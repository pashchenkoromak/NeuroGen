...
void Neuron::addSignal(const double _signal) noexcept { m_signal += _signal; }

double Neuron::getResult() const noexcept { return activation(); }
...
std::istream &operator>>(std::istream &is, Neuron &neuron) {}
